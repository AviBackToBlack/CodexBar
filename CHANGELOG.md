...
- Codex: honor access-token JWT expiry before the legacy eight-day refresh age so valid OAuth usage does not fall back to the CLI and lose model-specific limits.
