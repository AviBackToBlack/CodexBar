...
public struct OpenCodexUsageStore: Sendable {
    ...
    private static func payloadJSON(_ entry: OpenCodexUsageEntry) -> String {
        ...
        if let usage = entry.usage {
            ...
            if let inputTokens = usage.inputTokens { usageObject["inputTokens"] = inputTokens }
            if let outputTokens = usage.outputTokens { usageObject["outputTokens"] = outputTokens }
            ...
            if let totalTokens = usage.totalTokens { usageObject["totalTokens"] = totalTokens }
