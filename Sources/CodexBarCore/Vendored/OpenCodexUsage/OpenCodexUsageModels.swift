...
public enum OpenCodexUsageLog {
        ...
        fileManager: FileManager = .default) -> URL
    {
        ...
        {
            return URL(fileURLWithPath: override, isDirectory: true)
                .appendingPathComponent("codexbar-cache", isDirectory: true)
        }
        return AppGroupSupport.localFallbackDirectory(fileManager: fileManager)
            .appendingPathComponent("OpenCodexUsage", isDirectory: true)
    }
